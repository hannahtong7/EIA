...
#table <- data.frame(order=as.character(unique(South_side_invert_transects$Order)))
...
dat.messy <-
  read_xlsx("~/Documents/temp/EIA.git/Data/arran_data.xlsx",sheet="South side invert transects")
...
spp.check.ok <- name_backbone("Diptera", verbose = TRUE, strict = TRUE)
